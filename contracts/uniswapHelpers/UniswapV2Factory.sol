...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    function returnCreationTimeCode() public returns (bytes memory) {
...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        require(data.length == 0, "emtpy stirng notit");
        ...
        uint balance0Adjusted = balance0.mul(1000).sub(amount0In.mul(3)); //Taking a 0.3 percent fee
        uint balance1Adjusted = balance1.mul(1000).sub(amount1In.mul(3)); //Taking a 0.3 percent fee
